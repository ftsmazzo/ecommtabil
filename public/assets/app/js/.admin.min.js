...
pass=!0;if(pass)
$(window).trigger('jcKeyDown');keyDown=!0}});$(window).on('keyup',function(){keyDown=!1});w.jconfirm.lastClicked=!1;$(document).on('mousedown','button, a, [jc-source]',function(){w.jconfirm.lastClicked=$(this)})}));C:\wamp\www\dcf/public/assets/admin/js/common.min.js;