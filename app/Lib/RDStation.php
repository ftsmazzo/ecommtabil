...
class RDStation
{
    ...
    private function __request($method, $api) {
        ...
        curl_setopt($curl, CURLOPT_POSTFIELDS, json_encode($this->__leadData));
    ...
    private function __apiURL($api = 'conversions') {
        ...
        switch ($api) {
            ...
            case 'conversions':
                return $this->__apiBaseUrl.'1.3/conversions';
                break;

            case 'leads':
                return $this->__apiBaseUrl.'1.3/leads/'.$this->__leadEmail;
                break;

            case 'tags':
                return $this->__apiBaseUrl.'1.2/leads/'.$this->__leadEmail.'/tags';
                break;

            case 'generic':
                return $this->__apiBaseUrl.'1.2/services/'.$this->__apiPrivateToken.'/generic';
                break;
